...
// 3.判断是登录还是注册
if ($type === 'login') {
   $login_sql = "select * from user where phone='$phone' and pass='$pass'";
...
if ($type === 'add') {
    $add_sql = "select * from user where phone='$phone'";
    ...
    $insert_sql = "insert into user(phone,pass) values('$phone','$pass')";
